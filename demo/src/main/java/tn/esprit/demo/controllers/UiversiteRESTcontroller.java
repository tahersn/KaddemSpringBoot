...
public class UiversiteRESTcontroller {
    ...
    @PutMapping("/assignDep/{idDep}/{idUni}")

    public void assignDepartement(@PathVariable("idDep")Long idDep,@PathVariable("idUni") Long idUni){
        universiteImpl.assignUniversiteToDepartement(idUni,idDep);
    }
}
